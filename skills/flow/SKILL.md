---
name: flow
description: Produce a runtime sequence diagram for one flow, including failure paths, timeouts, retries, idempotency and consistency points. Use when the user asks for a flow, sequence diagram, or how a scenario behaves at runtime.
---
...
9. Add observability hooks — what is emitted at each significant step; these feed `/sa:gen-observability`.
...
**P9:** report which failure modes were covered and which were consciously skipped, then the next flow or `/sa:gen-lld <component>`.
