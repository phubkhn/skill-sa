...
| L4 | Code / detail | implementers | source code or implementation-specific model |
...
| Do not model physical indexes/partitions here — keep them in implementation documentation |
